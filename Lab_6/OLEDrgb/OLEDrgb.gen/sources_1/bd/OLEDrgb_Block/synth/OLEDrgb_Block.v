...
//Date        : Mon Dec 29 17:23:38 2025
//Host        : RUHUL running 64-bit major release  (build 9200)
//Command     : generate_target OLEDrgb_Block.bd
//Design      : OLEDrgb_Block
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "OLEDrgb_Block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=OLEDrgb_Block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=13,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=6,da_clkrst_cnt=1,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "OLEDrgb_Block.hwdef" *) 
module OLEDrgb_Block
   (jb_pin10_i,
    jb_pin10_o,
    jb_pin10_t,
    jb_pin1_i,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN OLEDrgb_Block_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  OLEDrgb_Block_PmodOLEDrgb_0_0 PmodOLEDrgb_0
       (.axi_lite_gpio_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .axi_lite_spi_araddr(axi_smc_M01_AXI_ARADDR),
        .axi_lite_spi_arprot(axi_smc_M01_AXI_ARPROT),
        .axi_lite_spi_arready(axi_smc_M01_AXI_ARREADY),
        .axi_lite_spi_arvalid(axi_smc_M01_AXI_ARVALID),
        .axi_lite_spi_awaddr(axi_smc_M01_AXI_AWADDR),
        .axi_lite_spi_awprot(axi_smc_M01_AXI_AWPROT),
        ...
        .axi_lite_spi_bresp(axi_smc_M01_AXI_BRESP),
        .axi_lite_spi_bvalid(axi_smc_M01_AXI_BVALID),
        .axi_lite_spi_rdata(axi_smc_M01_AXI_RDATA),
        .axi_lite_spi_rready(axi_smc_M01_AXI_RREADY),
        .axi_lite_spi_rresp(axi_smc_M01_AXI_RRESP),
        .axi_lite_spi_rvalid(axi_smc_M01_AXI_RVALID),
        .axi_lite_spi_wdata(axi_smc_M01_AXI_WDATA),
        .axi_lite_spi_wready(axi_smc_M01_AXI_WREADY),
        .axi_lite_spi_wstrb(axi_smc_M01_AXI_WSTRB),
  ...
  OLEDrgb_Block_axi_smc_0 axi_smc
  ...
  OLEDrgb_Block_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
        .s_axi_aclk(microblaze_0_Clk),
        ...
        .tx(usb_uart_txd));
  OLEDrgb_Block_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_1_locked),
        .reset(reset_inv_0_Res));
  OLEDrgb_Block_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > OLEDrgb_Block microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  OLEDrgb_Block_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_F60JL microblaze_0_local_memory
  ...
  OLEDrgb_Block_reset_inv_0_0 reset_inv_0
       (.Op1(reset),
        .Res(reset_inv_0_Res));
  OLEDrgb_Block_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_F60JL
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > OLEDrgb_Block microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  OLEDrgb_Block_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  OLEDrgb_Block_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  OLEDrgb_Block_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  OLEDrgb_Block_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  OLEDrgb_Block_lmb_bram_0 lmb_bram
