...
HD_PWD='F:/OLEDrgb/OLEDrgb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_Block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_Block_wrapper.tcl
