# 1 "F:\\oledrgb_workspace\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "F:\\oledrgb_workspace\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "F:\\oledrgb_workspace\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  #address-cells = <1>;
  #size-cells = <1>;
  PmodOLEDrgb_0: PmodOLEDrgb@44a00000 {
...
# 3 "F:\\oledrgb_workspace\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "nexys-a7-100t";
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x10000>,
         ...
         <0x44a00000 &PmodOLEDrgb_0 0x44a00000 0x10000>;
