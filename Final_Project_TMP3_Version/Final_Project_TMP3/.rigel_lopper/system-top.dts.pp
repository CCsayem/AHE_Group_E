# 1 "F:\\Final_Project_TMP3\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "F:\\Final_Project_TMP3\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "F:\\Final_Project_TMP3\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  PmodESP32_0: PmodESP32@44a00000 {
   interrupt-parent = <&axi_intc_0>;
   interrupts = < 1 0 >;
   compatible = "xlnx,PmodESP32-1.0";
   status = "okay";
   xlnx,ip-name = "PmodESP32";
   interrupt-names = "uart_interrupt";
   xlnx,pmod = "Custom";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x44a00000 0x10000 0x44a10000 0x10000>;
   xlnx,name = "PmodESP32_0";
  };
  PmodOLEDrgb_0: PmodOLEDrgb@44a20000 {
   xlnx,axi-lite-spi-data-width = <32>;
   xlnx,axi-lite-gpio-addr-width = <9>;
   compatible = "xlnx,PmodOLEDrgb-1.0";
   status = "okay";
   xlnx,axi-lite-spi-addr-width = <7>;
   xlnx,ip-name = "PmodOLEDrgb";
   xlnx,pmod = "Custom";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x44a20000 0x10000 0x44a30000 0x10000>;
   xlnx,axi-lite-gpio-data-width = <32>;
   xlnx,name = "PmodOLEDrgb_0";
  };
  ...
  axi_uartlite_1: serial@40600000 {
   interrupts = < 0 0 >;
...
# 3 "F:\\Final_Project_TMP3\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "nexys-a7-100t";
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x10000>,
         ...
         <0x40600000 &axi_uartlite_1 0x40600000 0x10000>,
         <0x41200000 &axi_intc_0 0x41200000 0x10000>,
         <0x44a00000 &PmodESP32_0 0x44a00000 0x10000>,
         <0x44a20000 &PmodOLEDrgb_0 0x44a20000 0x10000>;
