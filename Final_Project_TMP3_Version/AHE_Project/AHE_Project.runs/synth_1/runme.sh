...
HD_PWD='F:/AHE_Project/AHE_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esp32_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esp32_system_wrapper.tcl
