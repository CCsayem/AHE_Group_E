...
HD_PWD='F:/AHE_Project/AHE_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log esp32_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source esp32_system_wrapper.tcl -notrace
