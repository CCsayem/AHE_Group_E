...
HD_PWD='F:/AHE_Project/AHE_Project.runs/esp32_system_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esp32_system_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esp32_system_axi_gpio_0_0.tcl
