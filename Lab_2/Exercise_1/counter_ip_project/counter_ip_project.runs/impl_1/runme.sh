...
HD_PWD='F:/AHE_Final_Labs/Lab_2/Exercise_1/counter_ip_project/counter_ip_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_circuit_4_bit_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_circuit_4_bit_wrapper.tcl -notrace
