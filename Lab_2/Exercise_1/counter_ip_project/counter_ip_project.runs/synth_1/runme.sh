...
HD_PWD='F:/AHE_Final_Labs/Lab_2/Exercise_1/counter_ip_project/counter_ip_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_circuit_4_bit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_circuit_4_bit_wrapper.tcl
