...
//Command     : generate_target esp32.bd
//Design      : esp32
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "esp32,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=esp32,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=1,bdsource=USER,da_axi4_cnt=9,da_board_cnt=4,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "esp32.hwdef" *) 
module esp32
   (Pmod_out_0_pin10_i,
    Pmod_out_0_pin10_o,
    Pmod_out_0_pin10_t,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN1_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN1_0, CLK_DOMAIN esp32_clk_in1_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_in1_0;
  ...
  esp32_PmodESP32_0_1 PmodESP32_0
  ...
  esp32_axi_intc_0_0 axi_intc_0
       (.intr(axi_uartlite_1_interrupt),
  ...
  esp32_axi_uartlite_1_0 axi_uartlite_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > esp32 microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  esp32_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_12VOU0S microblaze_0_local_memory
  ...
  esp32_reset_inv_0_0 reset_inv_0
       (.Op1(reset),
        .Res(reset_inv_0_Res));
  esp32_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_12VOU0S
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > esp32 microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  esp32_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  esp32_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  esp32_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
