...
HD_PWD='F:/esp32/esp32.runs/esp32_axi_uartlite_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esp32_axi_uartlite_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esp32_axi_uartlite_1_0.tcl
