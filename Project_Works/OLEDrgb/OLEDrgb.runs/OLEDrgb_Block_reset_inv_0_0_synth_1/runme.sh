...
HD_PWD='F:/OLEDrgb/OLEDrgb.runs/OLEDrgb_Block_reset_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_Block_reset_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_Block_reset_inv_0_0.tcl
