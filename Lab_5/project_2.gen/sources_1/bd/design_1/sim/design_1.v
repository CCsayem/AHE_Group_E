...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 tmp3_scl TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [0:0]tmp3_scl_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 tmp3_scl TRI_O" *) output [0:0]tmp3_scl_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 tmp3_scl TRI_T" *) output [0:0]tmp3_scl_tri_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 tmp3_sda TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [0:0]tmp3_sda_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 tmp3_sda TRI_O" *) output [0:0]tmp3_sda_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 tmp3_sda TRI_T" *) output [0:0]tmp3_sda_tri_t;
  ...
  wire sys_clock;
  wire [0:0]tmp3_scl_tri_i;
  wire [0:0]tmp3_scl_tri_o;
  wire [0:0]tmp3_scl_tri_t;
  wire [0:0]tmp3_sda_tri_i;
  wire [0:0]tmp3_sda_tri_o;
  wire [0:0]tmp3_sda_tri_t;

  design_1_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(tmp3_sda_tri_i),
        .gpio2_io_o(tmp3_sda_tri_o),
        .gpio2_io_t(tmp3_sda_tri_t),
        .gpio_io_i(tmp3_scl_tri_i),
        .gpio_io_o(tmp3_scl_tri_o),
        .gpio_io_t(tmp3_scl_tri_t),
