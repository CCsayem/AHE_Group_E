...
HD_PWD='F:/esp32/esp32.runs/esp32_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esp32_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esp32_dlmb_bram_if_cntlr_0.tcl
