...
HD_PWD='F:/esp32/esp32.runs/esp32_PmodESP32_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esp32_PmodESP32_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esp32_PmodESP32_0_1.tcl
