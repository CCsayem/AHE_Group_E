...
HD_PWD='F:/OLEDrgb/OLEDrgb.runs/OLEDrgb_Block_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_Block_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_Block_ilmb_bram_if_cntlr_0.tcl
