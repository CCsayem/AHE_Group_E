...
HD_PWD='F:/OLEDrgb/OLEDrgb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_Block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OLEDrgb_Block_wrapper.tcl -notrace
