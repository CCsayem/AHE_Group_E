...
#
# Script generated by Vivado on Thu Nov 06 20:40:52 +0100 2025
...
#
# Usage        : four_bit_Adder.sh
#                four_bit_Adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                four_bit_Adder.sh [-reset_run]
#                four_bit_Adder.sh [-reset_log]
#                four_bit_Adder.sh [-help]
#
...
# script info
echo -e "four_bit_Adder.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./four_bit_Adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_10 -L xlconcat_v2_1_7 -L xlslice_v1_0_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot four_bit_Adder xil_defaultlib.four_bit_Adder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim four_bit_Adder -key {Behavioral:sim_1:Functional:four_bit_Adder} -tclbatch cmd.tcl -protoinst "protoinst_files/four_bit_Adder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb four_bit_Adder.wdb xsim.dir libdpi.so)
...
Usage: four_bit_Adder.sh [-step]\n\
Usage: four_bit_Adder.sh [-lib_map_path]\n\
Usage: four_bit_Adder.sh [-reset_run]\n\
Usage: four_bit_Adder.sh [-reset_log]\n\
Usage: four_bit_Adder.sh [-keep_index]\n\
