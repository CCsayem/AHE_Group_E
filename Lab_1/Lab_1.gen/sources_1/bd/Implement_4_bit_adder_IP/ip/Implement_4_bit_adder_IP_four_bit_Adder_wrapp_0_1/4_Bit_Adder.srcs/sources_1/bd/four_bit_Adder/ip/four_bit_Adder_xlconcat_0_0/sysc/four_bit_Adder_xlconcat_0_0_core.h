...
#ifndef _four_bit_Adder_xlconcat_0_0_core_h_
#define _four_bit_Adder_xlconcat_0_0_core_h_
...
class four_bit_Adder_xlconcat_0_0_core : public sc_module 
{
    public: 
       four_bit_Adder_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(four_bit_Adder_xlconcat_0_0_core);
    ...
    virtual ~four_bit_Adder_xlconcat_0_0_core() = default;
