...
#
# Script generated by Vivado on Thu Nov 06 20:55:14 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Implement_4_bit_adder_IP.sh
...
#
# Usage        : Implement_4_bit_adder_IP.sh
#                Implement_4_bit_adder_IP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Implement_4_bit_adder_IP.sh [-reset_run]
#                Implement_4_bit_adder_IP.sh [-reset_log]
#                Implement_4_bit_adder_IP.sh [-help]
#
...
# script info
echo -e "Implement_4_bit_adder_IP.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Implement_4_bit_adder_IP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_10 -L xlconcat_v2_1_7 -L xlslice_v1_0_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Implement_4_bit_adder_IP xil_defaultlib.Implement_4_bit_adder_IP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Implement_4_bit_adder_IP -key {Behavioral:sim_1:Functional:Implement_4_bit_adder_IP} -tclbatch cmd.tcl -protoinst "protoinst_files/Implement_4_bit_adder_IP.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Implement_4_bit_adder_IP.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Implement_4_bit_adder_IP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Implement_4_bit_adder_IP.sh [-help]\n\
Usage: Implement_4_bit_adder_IP.sh [-step]\n\
Usage: Implement_4_bit_adder_IP.sh [-lib_map_path]\n\
Usage: Implement_4_bit_adder_IP.sh [-reset_run]\n\
Usage: Implement_4_bit_adder_IP.sh [-reset_log]\n\
Usage: Implement_4_bit_adder_IP.sh [-keep_index]\n\
Usage: Implement_4_bit_adder_IP.sh [-noclean_files]\n\n\
